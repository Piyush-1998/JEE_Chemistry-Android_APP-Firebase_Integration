...
public class formula_pdf_opener extends AppCompatActivity {
    DatabaseReference mref2 = FirebaseDatabase.getInstance().getReference().child("formula");
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.mref2.addValueEventListener(new ValueEventListener() { // from class: com.pm161998.jeechemistry.formula_pdf_opener.1
