...
public final class zzapd implements Parcelable.Creator<zzape> {
    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ zzape[] newArray(int i) {
        return new zzape[i];
    }

    @Override // android.os.Parcelable.Creator
    public final /* synthetic */ zzape createFromParcel(Parcel parcel) {
        ...
        return new zzape(bundle, zzaxlVar, applicationInfo, str, arrayList, packageInfo, str2, z, str3);
    }
}
