...
public final class zzbhs implements zzdwb<Set<zzbqs<zzbnm>>> {
    ...
    private zzbhs(zzdwo<zzbhk> zzdwoVar, zzdwo<Executor> zzdwoVar2, zzdwo<JSONObject> zzdwoVar3) {
        this.zzfcs = zzdwoVar;
        this.zzfck = zzdwoVar2;
        this.zzfct = zzdwoVar3;
    }

    public static zzbhs zzd(zzdwo<zzbhk> zzdwoVar, zzdwo<Executor> zzdwoVar2, zzdwo<JSONObject> zzdwoVar3) {
        return new zzbhs(zzdwoVar, zzdwoVar2, zzdwoVar3);
    }
