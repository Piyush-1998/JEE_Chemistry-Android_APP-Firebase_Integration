...
public final class zzcag implements zzdwb<zzbqs<zztp>> {
    ...
    private zzcag(zzdwo<zzcaq> zzdwoVar, zzdwo<Executor> zzdwoVar2) {
        this.zzfcs = zzdwoVar;
        this.zzfck = zzdwoVar2;
    }

    public static zzcag zzl(zzdwo<zzcaq> zzdwoVar, zzdwo<Executor> zzdwoVar2) {
        return new zzcag(zzdwoVar, zzdwoVar2);
    }
