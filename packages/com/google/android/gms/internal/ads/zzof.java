...
public final class zzof {
    ...
    private static final Pattern zzbgu;
    private static final Pattern zzbgv;
    private static final Pattern zzbgw;
    private static final int[] zzbgx;
    ...
    public static void zza(zzne zzneVar) {
        if (zzneVar != null) {
            try {
                zzneVar.close();
