...
public final class zzazk {
    ...
    private static boolean zza(JSONObject jSONObject, String str, zzyp<Boolean> zzypVar) {
        return zza(jSONObject, str, ((Boolean) zzuv.zzon().zzd(zzypVar)).booleanValue());
    }
    ...
    private static int zzb(JSONObject jSONObject, String str, zzyp<Integer> zzypVar) {
        if (jSONObject != null) {
            try {
    ...
    private static String zzc(JSONObject jSONObject, String str, zzyp<String> zzypVar) {
        if (jSONObject != null) {
            try {
