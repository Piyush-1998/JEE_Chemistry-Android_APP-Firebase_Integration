...
public final class zzchx implements zzdwb<zzcho> {
    ...
    public zzchx(zzdwo<Context> zzdwoVar, zzdwo<zzaxl> zzdwoVar2, zzdwo<zzcwe> zzdwoVar3, zzdwo<Executor> zzdwoVar4, zzdwo<zzbso> zzdwoVar5, zzdwo<zzbzl> zzdwoVar6) {
        this.zzejy = zzdwoVar;
    ...
    public final /* synthetic */ Object get() {
        return new zzcho(this.zzejy.get(), this.zzfcq.get(), this.zzfef.get(), this.zzfdx.get(), this.zzfxj.get(), this.zzfno.get());
    }
}
