...
interface zzduk {
    ...
    void zza(int i, zzdpm zzdpmVar) throws IOException;

    <K, V> void zza(int i, zzdrx<K, V> zzdrxVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj, zzdsv zzdsvVar) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzdsv zzdsvVar) throws IOException;
    ...
    void zzak(int i, int i2) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzdsv zzdsvVar) throws IOException;

    void zzb(int i, List<zzdpm> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzdsv zzdsvVar) throws IOException;
    ...
    void zzo(int i, long j) throws IOException;
