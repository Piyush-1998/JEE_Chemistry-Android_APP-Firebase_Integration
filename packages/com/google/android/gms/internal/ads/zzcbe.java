...
public final class zzcbe implements zzdwb<zzbqs<zzbpc>> {
    ...
    private zzcbe(zzdwo<zzcbc> zzdwoVar, zzdwo<Executor> zzdwoVar2) {
        this.zzfcs = zzdwoVar;
        this.zzfck = zzdwoVar2;
    }

    public static zzcbe zzu(zzdwo<zzcbc> zzdwoVar, zzdwo<Executor> zzdwoVar2) {
        return new zzcbe(zzdwoVar, zzdwoVar2);
    }
