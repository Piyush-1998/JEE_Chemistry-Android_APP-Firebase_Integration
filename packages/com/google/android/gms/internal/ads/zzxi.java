...
public final class zzxi extends ContentProvider {
                ...
                try {
                    ...
                    try {
                        ...
                        if (str != null && !str.matches("^/\\d+~.+$")) {
                            ...
                            zzaxi.zzdv(valueOf.length() != 0 ? "Publisher provided Google AdMob App ID in manifest: ".concat(valueOf) : new String("Publisher provided Google AdMob App ID in manifest: "));
    ...
    private static Bundle zzh(Context context) {
        try {
            ...
            zzaxi.zzc("Failed to load metadata: Package name not found.", e);
            return null;
        } catch (NullPointerException e2) {
            zzaxi.zzc("Failed to load metadata: Null pointer exception.", e2);
            return null;
        }
    }
}
