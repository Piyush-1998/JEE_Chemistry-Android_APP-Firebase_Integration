...
public final class zzuk extends zzus<zzvl> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzuk(zzug zzugVar, Context context, zzua zzuaVar, String str, zzajx zzajxVar) {
        this.zzcdf = zzugVar;
    ...
    public final /* synthetic */ zzvl zzoe() {
        zzug.zza(this.val$context, "app_open");
        return new zzxq();
    }
    ...
    public final /* synthetic */ zzvl zzof() throws RemoteException {
        ...
        return zztvVar.zza(this.val$context, this.zzcdg, this.zzcdd, this.zzcde, 4);
    }
