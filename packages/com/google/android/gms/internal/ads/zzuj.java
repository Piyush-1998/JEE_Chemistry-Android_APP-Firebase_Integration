...
public final class zzuj extends zzus<zzvl> {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzuj(zzug zzugVar, Context context, zzua zzuaVar, String str, zzajx zzajxVar) {
        this.zzcdf = zzugVar;
    ...
    public final /* synthetic */ zzvl zzof() throws RemoteException {
        ...
        return zztvVar.zza(this.val$context, this.zzcdg, this.zzcdd, this.zzcde, 1);
    }

    @Override // com.google.android.gms.internal.ads.zzus
    public final /* synthetic */ zzvl zza(zzvu zzvuVar) throws RemoteException {
        return zzvuVar.zza(ObjectWrapper.wrap(this.val$context), this.zzcdg, this.zzcdd, this.zzcde, 15601000);
    }
}
