...
public final class zzdou {
    ...
    public static void zzc(zzdob zzdobVar) throws GeneralSecurityException {
        int i = zzdot.zzhez[zzdobVar.ordinal()];
        if (i == 1 || i == 2 || i == 3) {
            return;
        }
        String valueOf = String.valueOf(zzdobVar.name());
        throw new GeneralSecurityException(valueOf.length() != 0 ? "Unsupported hash: ".concat(valueOf) : new String("Unsupported hash: "));
    }
