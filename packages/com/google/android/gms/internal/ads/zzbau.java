    ...
    private static void zza(zzayw zzaywVar, Map<String, String> map) {
        ...
        if (str != null) {
            try {
                ...
                zzaug.zzeu(String.format("Could not parse buffer parameters in loadControl video GMSG: (%s, %s)", str, str2));
                return;
            }
        }
        if (str2 != null) {
    ...
    public final /* synthetic */ void zza(zzazj zzazjVar, Map map) {
        ...
        if (zzxl != null) {
            if ("timeupdate".equals(str)) {
                ...
                try {
                    ...
                    zzaug.zzeu(valueOf.length() != 0 ? "Could not parse currentTime parameter from timeupdate video GMSG: ".concat(valueOf) : new String("Could not parse currentTime parameter from timeupdate video GMSG: "));
                    return;
                }
        ...
        if (zzxg2 == null) {
            ...
            try {
                ...
                zzaug.zzeu(valueOf2.length() != 0 ? "Could not parse time parameter from currentTime video GMSG: ".concat(valueOf2) : new String("Could not parse time parameter from currentTime video GMSG: "));
            }
            ...
            if (str8 != null) {
                try {
                    ...
                    zzaug.zzeu(valueOf3.length() != 0 ? "Malformed demuxed URL list for playback: ".concat(valueOf3) : new String("Malformed demuxed URL list for playback: "));
            ...
            try {
                ...
                zzaug.zzeu(valueOf4.length() != 0 ? "Could not parse volume parameter from volume video GMSG: ".concat(valueOf4) : new String("Could not parse volume parameter from volume video GMSG: "));
            }
        } else if ("watermark".equals(str)) {
            zzxg2.zzxc();
        } else {
            String valueOf5 = String.valueOf(str);
            zzaug.zzeu(valueOf5.length() != 0 ? "Unknown video action: ".concat(valueOf5) : new String("Unknown video action: "));
        }
    }
}
