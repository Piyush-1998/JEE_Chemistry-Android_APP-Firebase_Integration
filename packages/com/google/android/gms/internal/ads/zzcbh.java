...
public final class zzcbh implements zzdwb<zzbqs<zzbnb>> {
    ...
    private zzcbh(zzdwo<zzcbc> zzdwoVar, zzdwo<Executor> zzdwoVar2) {
        this.zzfcs = zzdwoVar;
        this.zzfck = zzdwoVar2;
    }

    public static zzcbh zzx(zzdwo<zzcbc> zzdwoVar, zzdwo<Executor> zzdwoVar2) {
        return new zzcbh(zzdwoVar, zzdwoVar2);
    }
