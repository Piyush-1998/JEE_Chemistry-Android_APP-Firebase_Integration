...
public final class zzdmh implements zzdec {
    ...
    public final byte[] zzc(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        Cipher zzhf = zzdnu.zzhdz.zzhf("AES/GCM/NoPadding");
        zzhf.init(1, this.zzhau, zzf(zzff, 0, zzff.length));
        if (bArr2 != null && bArr2.length != 0) {
            zzhf.updateAAD(bArr2);
        }
        int doFinal = zzhf.doFinal(bArr, 0, bArr.length, bArr3, 12);
