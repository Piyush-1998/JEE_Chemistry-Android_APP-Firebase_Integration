...
public interface zzdsw {
    ...
    <T> T zza(zzdsv<T> zzdsvVar, zzdqj zzdqjVar) throws IOException;

    <T> void zza(List<T> list, zzdsv<T> zzdsvVar, zzdqj zzdqjVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzdrx<K, V> zzdrxVar, zzdqj zzdqjVar) throws IOException;
    ...
    @Deprecated
    <T> T zzb(zzdsv<T> zzdsvVar, zzdqj zzdqjVar) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzdsv<T> zzdsvVar, zzdqj zzdqjVar) throws IOException;
