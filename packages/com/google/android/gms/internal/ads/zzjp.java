...
final class zzjp {
    ...
    public final long zza(zziv zzivVar, boolean z, boolean z2, int i) throws IOException, InterruptedException {
        if (this.state == 0) {
            if (!zzivVar.zza(this.zzana, 0, 1, z)) {
                return -1L;
            }
            int zzaj = zzaj(this.zzana[0] & 255);
            this.length = zzaj;
            if (zzaj == -1) {
        ...
        if (i2 != 1) {
            zzivVar.readFully(this.zzana, 1, i2 - 1);
        }
        this.state = 0;
