...
interface zzim {
    ...
    <K, V> void zza(int i, zzfz<K, V> zzfzVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzgx zzgxVar) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzgx zzgxVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzgx zzgxVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, List<?> list, zzgx zzgxVar) throws IOException;
