...
public interface zzgy {
    ...
    <T> T zza(zzgx<T> zzgxVar, zzel zzelVar) throws IOException;

    <T> void zza(List<T> list, zzgx<T> zzgxVar, zzel zzelVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzfz<K, V> zzfzVar, zzel zzelVar) throws IOException;

    @Deprecated
    <T> T zzb(zzgx<T> zzgxVar, zzel zzelVar) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzgx<T> zzgxVar, zzel zzelVar) throws IOException;
