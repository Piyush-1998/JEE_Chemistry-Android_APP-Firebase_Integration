...
public final class zzjp implements zzjq {
    ...
    static {
        ...
        zzaqj = zzctVar.zze("measurement.monitoring.sample_period_millis", 86400000L);
        ...
        zzaqm = zzctVar.zze("measurement.config.cache_time.service", 86400000L);
        ...
        zzaqp = zzctVar.zze("measurement.upload.stale_data_deletion_interval", 86400000L);
